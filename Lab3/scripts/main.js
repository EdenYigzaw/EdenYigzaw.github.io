...
function populateListProductChoices() {
    var s = document.getElementById("displayProduct");
    ...
    var optionArray = restrictListProducts(products, lactoseFree, nutFree, organic);
	...
	for (i = 0; i < optionArray.length; i++) {
		...
		image.src = ('images/' + optionArray[i] + '.jpeg').toLowerCase();
		s.appendChild(image);
